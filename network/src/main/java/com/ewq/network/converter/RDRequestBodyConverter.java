...
import com.ewq.network.utils.SerializedUtil;
...
final class RDRequestBodyConverter<T> implements Converter<T, RequestBody> {
    private static final MediaType MEDIA_TYPE = MediaType.parse("application/x-www-form-urlencoded; charset=UTF-8;application/json;");
