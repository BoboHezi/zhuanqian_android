...
class AppResultCode {
     ...
     * 系统维护中
     */
    public static final int SYSTEM_MAINTAIN = 501;
    /**
     * 成功
     */
    ...
    public static final int HTTP_NET_EXCEPTION = 400; //400请求错误
    public static final int HTTP_NO_NET_EXCEPTION = 1003; //1003请检查是否连接网络
    public static final int HTTP_NET_TIME_OUT = 408; //408请求超时,请检查网络
    public static final int HTTP_NET_HTTP_ERROR = 500; //500请求内部错误
    public static final int HTTP_NET_HTTP_NO = 404; //404内部错误,请求不存在
}
