    ...
    public void initBqs() {
        BqsDF.setOnBqsContactsListener(new OnBqsContactsListener() {
            ...
            public void onSuccess(String tokenKey) {
                if (BuildConfig.DEBUG)
                    System.out.println("====联系人信息提交成功 tokenKey=" + tokenKey);
            }

            @Override
            public void onGatherResult(boolean hasContacts, boolean hasCallRecord, boolean hasSmsRecord) {
                if (BuildConfig.DEBUG)
                    System.out.println("====联系人信息采集结果 hasContacts=" + hasContacts + ",hasCallRecord=" + hasCallRecord + ",hasSmsRecord=" + hasSmsRecord);
            }

            @Override
            public void onFailure(String resultCode, String resultDesc) {
                if (BuildConfig.DEBUG)
                    System.out.println("====联系人信息提交失败 resultCode=" + resultCode + ",resultDesc=" + resultDesc);
            }
        });
        BqsDF.setOnBqsDFListener(new OnBqsDFListener() {
            ...
            public void onSuccess(String tokenKey) {
                //设备指纹调用成功
                if (BuildConfig.DEBUG)
                    System.out.println("====设备指纹调用成功 tokenkey=" + tokenKey);
            }
            ...
            public void onFailure(String resultCode, String resultDesc) {
                //设备指纹调用失败
                if (BuildConfig.DEBUG)
                    System.out.println("====设备指纹调用失败 resultCode=" + resultCode + ",resultDesc=" + resultDesc);
            }
        });
