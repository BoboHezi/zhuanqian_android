...
import com.ewq.tools.Config;
import com.ewq.tools.utils.ContextHolder;
import com.ewq.tools.utils.DateUtil;
    ...
    private static void writeLog(int type, String msg) {
        ...
        try {
            ...
            msg = new StringBuffer()
                    .append("\r\n")
                    .append(DateUtil.formatter(DateUtil.Format.SECOND, System.currentTimeMillis()))
            ...
            final String fileName = new StringBuffer()
                    .append(LOG_PREFIX)
                    .append(DateUtil.formatter(DateUtil.Format.DATE, System.currentTimeMillis()))
                    .append(".log").toString();
